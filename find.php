      ...
      <div class="col-sm-12"><div id="header">
        ...
        <div class="col-sm-8"><div id="content">
          <BR><BR>
            ...
            $find=$_POST['find'];
            $sql="SELECT * FROM content WHERE topic like '%$find%' AND status='s1'";
            $result = $conn->query($sql);
            $nub=0;
            $page=$_GET['page'];
            while($row = $result->fetch_object()){                
              $nub++;
              echo "<h1><center><U>พบบทความที่ค้นหา</U></center></h1>";
...
if($nub==0){
  echo "<h1><center><U>ไม่พบบทความที่ค้นหา</U></center></h1>";
