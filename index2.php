      ...
      <div class="col-sm-12"><div id="header">
        ...
        <div class="col-sm-8"><div id="content">
          <BR><BR>
            ...
            if($_GET['page']!=1){
             $page = $_GET['page']-1;
             echo "<a href=\"index2.php?page=$page\" <button type=\"button\" class=\"btn btn-default\"style=\"margin-right:0px;\"><span class=\"glyphicon glyphicon-arrow-left\"></span>BACK&nbsp;</button></a>";
           }
           if($nub>4){
            $page = $_GET['page']+1;
            //echo $page."page";
            echo "<a href=\"index2.php?page=$page\" <button type=\"button\" class=\"btn btn-default\"style=\"margin-left:500px;\"><span class=\"glyphicon glyphicon-arrow-right\"></span>NEXT&nbsp;</button></a>";
          }  
          echo"<br><br>"; 
